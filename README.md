...
- GitHub Pages deployment publishes versioned docs from CI:
  - `latest/` tracks `main`
  - `branches/<branch-name>/` for branch builds (including `dev`, feature branches)
  - `releases/<tag>/` for tags matching `v*`
